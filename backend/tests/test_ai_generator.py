...
class TestAIGeneratorNonToolResponses:
    ...
    def test_simple_text_response(self, mock_text_response):
        ...
        with patch('anthropic.Anthropic') as mock_anthropic:
            mock_client = Mock()
            mock_client.messages.create.return_value = mock_text_response("Hello, how can I help?")
    ...
    def test_response_without_tools(self, mock_text_response):
        ...
        with patch('anthropic.Anthropic') as mock_anthropic:
            mock_client = Mock()
            mock_client.messages.create.return_value = mock_text_response("General knowledge answer")
            mock_anthropic.return_value = mock_client
...
class TestAIGeneratorToolUse:
    ...
    def test_tool_use_detection(self, mock_tool_use_response, mock_text_response):
        ...
        with patch('anthropic.Anthropic') as mock_anthropic:
            ...
            mock_client.messages.create.side_effect = [
                ...
                mock_text_response("Based on the search results, machine learning is...")
            ]
            mock_anthropic.return_value = mock_client

            # Set up tool manager
            mock_store = Mock()
            mock_store.search = Mock(return_value=Mock(
    ...
    def test_tool_manager_execute_called(self, mock_tool_use_response, mock_text_response):
        ...
        with patch('anthropic.Anthropic') as mock_anthropic:
            ...
            mock_client.messages.create.side_effect = [
                mock_tool_use_response(
                    ...
                    tool_input={"query": "neural networks", "course_name": "Deep Learning"}
                ),
            ...
            tool_manager = Mock()
            tool_manager.execute_tool = Mock(return_value="Search results about neural networks")
...
class TestAIGeneratorMessageSequence:
    ...
    def test_message_sequence_structure(self, mock_tool_use_response, mock_text_response):
...
class TestAIGeneratorEmptyToolResults:
    ...
    def test_empty_tool_result_handling(self, mock_tool_use_response, mock_text_response):
    ...
    def test_tool_result_passed_to_final_call(self, mock_tool_use_response, mock_text_response):
...
class TestAIGeneratorSequentialToolCalling:
    ...
    def test_two_sequential_tool_calls(self, mock_tool_use_response, mock_text_response):
        ...
        with patch('anthropic.Anthropic') as mock_anthropic:
            ...
            mock_client.messages.create.side_effect = [
                ...
                mock_text_response("Final answer combining course outline and search results")
            ]
            mock_anthropic.return_value = mock_client
    ...
    def test_tools_included_in_follow_up_calls(self, mock_tool_use_response, mock_text_response):
        ...
        with patch('anthropic.Anthropic') as mock_anthropic:
            ...
            tools_definition = [{"name": "search_course_content", "description": "Search"}]
            generator = AIGenerator(api_key="test-key", model="test-model")
            generator.generate_response(
                query="Test query",
    ...
    def test_max_rounds_limit(self, mock_tool_use_response, mock_text_response):
        ...
        with patch('anthropic.Anthropic') as mock_anthropic:
            ...
            mock_client.messages.create.side_effect = [
                ...
                mock_tool_use_response(tool_id="toolu_3"),  # Would be 3rd round, but won't be reached
            ]
            mock_anthropic.return_value = mock_client
    ...
    def test_tool_execution_error_handling(self, mock_tool_use_response, mock_text_response):
    ...
    def test_early_exit_on_non_tool_response(self, mock_tool_use_response, mock_text_response):
    ...
    def test_message_accumulation_across_rounds(self, mock_tool_use_response, mock_text_response):
